...
export class AdministratorController {
    ...
    //GET http://localhost:4000/api/administrator
    @Get()
    getAll(): Promise<Administrator[]> {
        return this.administratorService.getAll()
    }

    //GET http://localhost:4000/api/administrator/4/
    @Get(':id')
    ...
    //PUT http://localhost:4000/api/administrator
    @Put()
    add(@Body() data: AddAdministratorDto): Promise<Administrator> {
        return this.administratorService.add(data);
    }

    //POST http://localhost:4000/api/administrator
    @Post(':id')
