...
export class ArticleFeature {
  ...
  @Column({
    type: "int", name: "article_id", unsigned: true, default: () => "'0'"
  })
  articleId: number;

  @Column({ type: "int", name: "feature_id", unsigned: true, default: () => "'0'" })
  featureId: number;

  @Column({ type: "varchar", name: "value", length: 255, default: () => "'0'" })
  value: string;
